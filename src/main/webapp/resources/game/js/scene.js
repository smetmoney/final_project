...
window.scene2 = {
	...
	options: [
		...
		},
		{
			...
			actionText: [
				'(빅토르와의 대화 시작)',
				'마이크: "빅토르, 당신은 이 박물관의 관장이군요. 보석 사건에 대한 정보가 있을까요?"',
	...
	options: [
		{
			...
			actionText: [
				...
				'마이크: "알겠습니다, 그럼 사건 당시에 이상한 점은 없었나요?"',
...
window.scene7 = {
	introText: [
		'(카렌의 사무실 조사 결과)',
		'카렌의 사무실에서 어떤 흥미로운 편지를 발견했다. 그 편지는 보석 사건과는 무관해 보이지만, 카렌은 어떤 비밀을 숨기고 있는 듯한 느낌을 준다. 이 편지가 어떤 의미를 가지고 있는지 알아내야 할 것이다.',
		'(빅토르를 조사해보자)'
	],
	options: [
		{
			...
			actionText: [
				'(조사 - 빅토르 위고)',
				'마이크: "빅토르, 반갑습니다. 조금 더 구체적인 조사를 해보려고합니다.',
				...
				'마이크: "감사합니다, 빅토르. 우리는 최선을 다해 사건을 해결하겠습니다."',
			],
			color: "skyblue"
		}
	],
	...
	options : [
		{
			...
			actionText: [
				'(빅토르의 사무실로 들어간다.)' // 빅토르의 사무실을 들어가려고하니 갑자기 빅토르가 나왔다.
			],
			color: "red",
			gameType : "find_alex"
	...
	options : [
		{
			...
			actionText : [
				...
				'마이크: "그러면 그들의 과거와 갈등을 풀어내면서 사건의 진상을 밝히는 것이 좋겠군요."',
	...
	options : [
		{
			...
			actionText : [
				'(카렌을 발견했다.)',
				'마이크: "카렌, 우리는 보석 사건에 대한 진실을 알아내려고 노력하고 있어요."',
				'카렌: "말할 수 없는 비밀들이 박물관 안에 숨겨져 있어요. 그리고 그 비밀들이 보석 사건과 연관되어 있을지도 모르겠어요."',
				'마이크: "비밀을 밝히면 사건의 진상이 해결될 수 있을 것 같아요. 카렌, 저희에게 무슨 일이 일어난 건지 말씀해주실 수 있나요?"',
				'카렌: "저는 박물관의 보안을 담당하고 있었어요. 그리고 그 일 중에 알렉스와 에밀리의 관계를 알게 되었어요."',
				'카렌: "그들은 불륜 관계에 빠져 있었고, 그 사실을 밝혀내면서 나는 그들의 음모와 계획을 알게 되었어요."',
				'마이크: "그래서 알렉스와 에밀리는 보석을 훔치기 위해 음모를 꾸몄다는 건가요?"',
				'카렌: "맞아요. 그들은 보석을 훔쳐서 박물관을 떠나려고 했어요. 그리고 그 사실이 드러나면서 나는 이 사건을 막기 위해 힘쓰게 되었어요."',
				'마이크: "카렌, 우리와 함께 그들의 계획을 저지하고 보석을 지키는 데 도움을 줄 수 있나요?"',
...
window.scene12 = {
	introText : [
		'(에밀리의 방에서 발견된 협박편지와 카렌과의대 화를 통해 알렉스와 에밀리 사이의 음모를 직감한다.)',
		'(이제 에밀리와 알렉스에게 직접 물어보고 진실을 밝혀내야 한다.)',
		'(에밀리의 방으로 향하며 그들과 대화할 준비를 한다.)'
	],
	options : [
		{
			buttonText : '에밀리의 방으로 간다.',
			actionText : [
				'(에밀리의 방으로 들어가 에밀리와 알렉스에게 진실을 묻는다.)'
			]
		}
	],
	action: "SELECT",
...
window.scene13 = {
	introText : [
		'(에밀리의 방으로 들어가 에밀리와 알렉스에게 진실을 묻는다.)',
		'마이크: "에밀리, 빅토르. 저희는 이제 모든 단서를 모았고, 진실을 알아내기 위해 여기 왔어요."',
		'에밀리: "무슨 말이에요? 어떤 진실을 말하시는 거죠?"',
		'빅토르: "마이크, 어떻게 여기까지 왔지?"',
		'마이크: "에밀리, 알렉스. 당신들은 이미 알고 있는 사실을 숨기지 마세요. 당신들의 관계와 사건의 배후에 얽힌 음모를 우리에게 이야기해주세요."',
		'에밀리: "마이크, 너무 이상한 얘기를 하는 것 같은데요?"',
		'마이크: "협박편지가 에밀리의 방에서 발견되었어요. 그리고 레베카와의 대화를 통해 우리는 당신들의 관계와 음모에 대해 짐작할 수 있었어요."',
		'에밀리: "에이, 그건 우연이에요. 우리는 아무런 음모도 없었어요."',
		'빅토르: "우리가 지금 무슨 음모를 꾸미고 있다는 거야?"',
		'에밀리: "오히려 저는 피해자라고요 ! "',
		'마이크: "제가 본 단서에선 카렌의 해고서에 작성된 빅토르 위고의 이름과 협박편지의 필체가 똑같더군요."',
		'마이크: "에밀리 , 당신 방에 있던 작은 조각상자를 기억하시나요 ? "',
		'마이크: "그 작은 조각상자는 카렌의 사무실에서 발견된 보석상자와 맞아 떨어져요. 그리고 협박편지는 빅토르가 쓴 것이었고, 카렌에게 뒤집어씌우려 했던 것으로 추정됩니다."',
		'(에밀리와 빅토르는 서로를 보며 깊게 숨을 들이마셨다.)',
		'마이크: "우리는 어떤 선택을 하든 이걸 끝내야겠군요."'
	],
	options : [
		{
			...
			actionText : [
				...
				'마이크: "그건 당신들의 이야기일뿐이지않을까요 . 에밀리, 빅토르"',
				'알렉스: "하.. 어쩔수 없군.."',

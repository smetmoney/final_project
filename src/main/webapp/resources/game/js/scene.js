...
window.scene13 = {
	introText : [
		...
		'빅토르: "마이크, 어떻게 여기까지 왔지?"',
		'마이크: "에밀리, 빅토르. 당신들은 이미 알고 있는 사실을 숨기지 마세요. 당신들의 관계와 사건의 배후에 얽힌 음모를 우리에게 이야기해주세요."',
		'에밀리: "마이크, 너무 이상한 얘기를 하는 것 같은데요?"',
		'마이크: "협박편지가 에밀리의 방에서 발견되었고, 그리고 레베카와의 대화를 통해 우리는 당신들의 관계와 음모에 대해 짐작할수 있었습니다."',
	...
	options : [
		{
			...
			actionText : [
				...
				'마이크: "카렌 , 제가 쫓아가보겠습니다. 당신은 에밀리의 사무실에 가서 보석이 든 상자를 찾아주세요."'
			],
    ...
    options: [
        {
            ...
            actionText: [
                '마이크: "빅토르, 어디로 도망가려고 했어? 너희의 음모는 이미 밝혀졌어."',
                '빅토르: "마이크, 날 잡아도 아무 소용없어. 이미 끝난 일이야."',
                '에밀리: "빅토르, 어쩔 수 없어. 우리는 선택을 해야 해."',
                '마이크: "너희가 말하는 선택은 어떤 거지?"',
                '에밀리: "우리는 진실을 말하려고 해. 우리가 범죄자가 아니라는 걸."',
                '빅토르: "이미 모든 게 끝난 거야. 우린 더는 도망칠 곳이 없어."',
                '마이크: "당신들은 법의 품 안에서 살아가야 할 것이다. 그리고 그것은 당신들이 결정하는 게 아니야."'
            ],
        }
    ],
    action: "END",

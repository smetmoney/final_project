...
<style>
	#back {
	    ...
	    margin-top: -330px;
	    user-select: none;
		background: url('${path}/resources/game/subGame/image/victor_office.jpg');
...
<section>
        <article id="screen">
            ...
            <div id="back">
                <img class="clicker" id="smallBox" src="${path}/resources/game/subGame/image/box.png" onclick="box();">
                <img class="clicker" id="smallKey" src="${path}/resources/game/subGame/image/key.png" onclick="key();">
            </div>

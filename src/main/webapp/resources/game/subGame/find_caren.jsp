...
<style>
	#back {
	    ...
	    margin-top: -330px;
	    user-select: none;
		background: url('${path}/resources/game/subGame/image/caren_office.jpg');
...
<section>
        <article id="screen">
            ...
            <div id="close" onclick="XClick('caren');">
            </div>
            <div id="back">
                <img class="clicker" id="smallLamp" src="${path}/resources/game/subGame/image/lamp.png" onclick="lamp();">
                <img class="clicker" id="smallLetter" src="${path}/resources/game/subGame/image/letter.png" onclick="letter();">
            </div>
            ...
            <div class="speech" id="spc01" onclick="clr1();">
       		...
       		<div class="speech" id="spcLetter" onclick="clr1();">
       			<h1>책상 안</h1>
       			<p>어떤 편지를 발견했다. </p>
       		</div>
            <div class="speech" id="spcLamp" onclick="clr1();">
                <h1>책상 위</h1>
                <p>램프를 발견했다. 어딘가에 쓸 곳이 있을거 같다.</p>
            </div>
        </article>
